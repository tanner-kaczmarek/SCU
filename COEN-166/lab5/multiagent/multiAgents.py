...
class ReflexAgent(Agent):
    ...
    def evaluationFunction(self, currentGameState, action):
        ...
        #print('new Pos: ', newPos, ' new Food: ', newFood, ' newGhostStates: ', newGhostStates, ' newScaredTimes: ', newScaredTimes, ' \n')
        ...
        #Ghosts are scared, or ghosts are so far away that we can just forget about the ghost right now 
